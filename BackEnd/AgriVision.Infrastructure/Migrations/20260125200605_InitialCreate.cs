    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubscriptionPlanLookups", x => x.Id);
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1B2D3C4E-5F67-4890-ABCD-1234567890AB", "E0B2F8D1-1CC7-4A63-9DBD-4E3B2B39B889", "Farmer", "FARMER" },
                    { "7C7F1A7B-9F2F-4E61-8B1A-1A8D2F3A9A11", "F1C1B9B9-7A75-4B2A-B5E2-0B5E9AF5C311", "Admin", "ADMIN" }
                });

            migrationBuilder.InsertData(
                table: "SubscriptionPlanLookups",
                columns: new[] { "Id", "Name", "Plan", "Price" },
                values: new object[,]
                {
                    { 1, "Free", 0, 0m },
                    { 2, "Basic", 1, 49.99m },
