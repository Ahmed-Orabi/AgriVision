...
@Component({
  selector: 'app-disease-pest-detection',
  imports: [SidebarComponent, TopNavbarComponent, FooterComponent, BottomNavComponent],
  templateUrl: './disease-pest-detection.html',
})
export class DiseasePestDetectionPage implements OnInit {
  constructor(private pageStyles: PageStylesService) {}

  ngOnInit(): void {
    this.pageStyles.setStyles(["/assets/css/themeDashboard.css","/assets/css/DiseasePestDetection.css"], 'agri-page-dashboard', 'disease-pest');
  }
}
