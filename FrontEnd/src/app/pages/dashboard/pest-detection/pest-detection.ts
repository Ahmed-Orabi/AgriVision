...
@Component({
  ...
  templateUrl: './pest-detection.html',
})
export class PestDetectionPage implements OnInit {
  constructor(private pageStyles: PageStylesService) {}

  ngOnInit(): void {
    this.pageStyles.setStyles(["/assets/css/themeDashboard.css","/assets/css/DiseasePestDetection.css"], 'agri-page-dashboard', 'pest');
  }
}
