...
class DataTransformationConfig:
    preprocessor_ogj_file_path = os.path.join('Crop_Recommendation_System', 'artifacts',"preprocessor.pkl")
    label_encoder_obj_file_path = os.path.join('Crop_Recommendation_System', 'artifacts', "label_encoder.pkl")
