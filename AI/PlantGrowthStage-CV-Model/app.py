...
app = FastAPI(title="Plant Growth Stage Detection CV API", version="1.0")

# call the model
model = YOLO('last_model_v2_best.onnx', task='detect')

@app.get("/")
def read_root():
    return {"message": "YOLOv8 Plant Growth Stage Detection API is running!"}
